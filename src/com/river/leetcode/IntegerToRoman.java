...
public class IntegerToRoman {
     ...
     * @param args
     */
    private static final Map<Integer, String> romanNums = Stream
            .of(new Object[][] {{1000, "M"}, {900, "CM"}, {500, "D"}, {400, "CD"}, {100, "C"},
                    {90, "XC"}, {50, "L"}, {40, "XL"}, {10, "X"}, {9, "IX"}, {5, "V"}, {4, "IV"},
                    {1, "I"},})
            .collect(Collectors.toMap(data -> (Integer) data[0], data -> (String) data[1]));

    private static final List<Integer> nums = Arrays.stream(romanNums.keySet().toArray())
    ...
    public static String intToRoman(int num) {
        ...
        Map<Integer, Integer> containRomanNums = Stream
                .of(new Object[][] {{1000, 0}, {900, 0}, {500, 0}, {400, 0}, {100, 0}, {90, 0},
