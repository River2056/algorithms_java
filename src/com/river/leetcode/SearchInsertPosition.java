...
public class SearchInsertPosition {
   ...
   *
   * <p>Example 1: Input: nums = [1,3,5,6], target = 5 Output: 2 Example 2: Input: nums = [1,3,5,6],
   * target = 2 Output: 1 Example 3: Input: nums = [1,3,5,6], target = 7 Output: 4
   *
   * <p>Constraints: 1 <= nums.length <= 104 -104 <= nums[i] <= 104 nums contains distinct values
