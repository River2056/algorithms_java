...
public class SpiralMatrix {
  ...
  private void traverseMatrix(int[][] matrix, List<Integer> result, int rowIndex, int columnIndex) {
    ...
    if (rowIndex + dirY[dir] < 0
        || rowIndex + dirY[dir] >= ROWS
        || columnIndex + dirX[dir] < 0
