...
public class TreeNode<T> {
  ...
  public boolean equals(Object obj) {
    ...
    if (leftChild == null) {
      if (other.leftChild != null) return false;
    } else if (!leftChild.equals(other.leftChild)) return false;
    if (rightChild == null) {
      if (other.rightChild != null) return false;
    } else if (!rightChild.equals(other.rightChild)) return false;
    if (value == null) {
  ...
  public String toString() {
    return String.format(
        "{ value: %s, left: %s, right: %s }", this.value, this.leftChild, this.rightChild);
  }
}
